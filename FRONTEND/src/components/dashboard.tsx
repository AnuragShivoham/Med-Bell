...
import { Clock, Pill, CheckCircle2, Bell, VolumeX, Volume2, Heart, TrendingUp, Zap } from "lucide-react";
...
export function Dashboard() {
  const [medicines, setMedicines] = useState([
    { id: 1, name: "Vitamin D3", time: "8:00 AM", taken: true, dosage: "1000 IU" },
    { id: 2, name: "Metformin", time: "12:00 PM", taken: false, dosage: "500mg" },
    { id: 3, name: "Omega-3", time: "2:00 PM", taken: false, dosage: "1000mg" },
    { id: 4, name: "Blood Pressure Med", time: "8:00 PM", taken: false, dosage: "10mg" }
  ]);
        ...
        <Card className="relative overflow-hidden bg-gradient-to-br from-emerald-500/10 to-green-500/10 backdrop-blur-xl border border-emerald-200/30 hover:border-emerald-300/50 transition-all duration-300 group">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-emerald-600/80 text-sm">Taken Today</p>
                <p className="text-2xl font-bold text-emerald-700">{takenMedicines.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>

        <Card className="relative overflow-hidden bg-gradient-to-br from-amber-500/10 to-orange-500/10 backdrop-blur-xl border border-amber-200/30 hover:border-amber-300/50 transition-all duration-300 group">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-amber-600/80 text-sm">Pending</p>
        ...
        <Card className="relative overflow-hidden bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-pink-500/10 backdrop-blur-xl border border-indigo-200/30 shadow-2xl">
          ...
          <CardContent className="relative text-center space-y-6">
            <div className="p-8 rounded-2xl bg-white/40 backdrop-blur-sm border border-white/30 shadow-xl">
              ...
              <p className="text-xl text-slate-600 mb-6 flex items-center justify-center gap-2">
              ...
              <Button
                onClick={() => markMedicineTaken(nextMedicine.id)}
                className="px-8 py-4 text-lg bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-indigo-600 hover:via-purple-600 hover:to-pink-600 text-white shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 rounded-xl"
              >
